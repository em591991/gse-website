      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6">
          ...
          <a
            ...
            className="inline-flex items-center bg-white rounded-full px-6 py-3 shadow-md hover:shadow-lg transition-shadow duration-200"
          >
          ...
          {/* HBA Logo */}
          <div className="inline-block bg-white rounded-lg px-4 py-2 shadow-md">
            <img
              src={hbaLogo}
